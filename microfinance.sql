...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2018 at 05:42 PM
...
CREATE TABLE `applicant` (
  ...
  `Types of Business` varchar(25) NOT NULL,
  `Loan Type` varchar(10) NOT NULL,
...
INSERT INTO `applicant` (`NID`, `Asset`, `Types of Business`, `Loan Type`, `Loan ID`) VALUES
(2147483647, 'Has........', 'BUs', 'Dabi', 1000000001);
...
CREATE TABLE `borrower` (
  ...
  `Loan Length` int(3) NOT NULL,
  `Interest` float NOT NULL,
  `Monthly Pdate` datetime NOT NULL,
  `Credit point` int(5) NOT NULL,
  `AdminID` int(11) NOT NULL,
...
('Sabina', 'Islam', 'F', 1958034975, '1452', 'ngfhr@gmail.com', 45, 145),
...
--
ALTER TABLE `borrower`
  ADD CONSTRAINT `borrower_ibfk_1` FOREIGN KEY (`Loan ID`) REFERENCES `applicant` (`Loan ID`) ON UPDATE CASCADE,
...
('root', '[{\"db\":\"microfinance\",\"table\":\"borrower\"},{\"db\":\"microfinance\",\"table\":\"applicant\"},{\"db\":\"microfinance\",\"table\":\"loan type\"},{\"db\":\"microfinance\",\"table\":\"user\"},{\"db\":\"microfinance\",\"table\":\"admin\"},{\"db\":\"mysql\",\"table\":\"users\"},{\"db\":\"mysql\",\"table\":\"db\"},{\"db\":\"mysql\",\"table\":\"admin\"},{\"db\":\"mysql\",\"table\":\"bloodgroup\"},{\"db\":\"mysql\",\"table\":\"applicant\"}]');
...
('root', '2018-11-27 16:41:20', '{\"Console\\/Mode\":\"collapse\"}');
